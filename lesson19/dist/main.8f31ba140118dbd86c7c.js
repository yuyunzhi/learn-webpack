...
"use strict";
/* WEBPACK VAR INJECTION */(function($, _join) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ui; });
function ui() {
  $('body').css('background', _join(['green'], ''));
}
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(0), __webpack_require__(1)["join"]))
...
dom.html(lodash__WEBPACK_IMPORTED_MODULE_0___default.a.join(['yYY', 'kk']), '-----');
